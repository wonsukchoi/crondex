...
export const CATEGORY_DESCRIPTIONS = {
  ...
  banking: "Retail/community bank and credit union ops — KYC/AML, dormant accounts, teller variance, reg reporting.",
  childcare: "Daycare compliance and ops — ratios, immunizations, tuition.",
  "cleaning-services":
    "Commercial/residential cleaning and janitorial business ops — crew hours, background checks, missed cleans, damage claims, chemical safety.",
  ...
  dental: "Dental practice ops — hygiene recall, claims, chart compliance, lab cases, production.",
  ...
  "law-firm": "Law firm practice management ops — trust accounting, conflict checks, matter deadlines, CLE, billing.",
  ...
  "moving-relocation":
    "Household/office moving company ops — crew dispatch, estimates, claims, DOT compliance, storage-in-transit.",
  ...
  payments: "Payment processor/merchant acquirer ops — chargebacks, disputes, settlement, PCI, KYB, funding.",
  ...
  photography: "Photo/video studio ops — gallery delivery, releases, backups, licensing, retainers.",
  ...
  "short-term-rental":
    "Airbnb/VRBO/vacation-rental host ops — turnover cleaning, calendar/pricing sync, guest screening, deposits, permits, occupancy tax.",
  "self-storage":
    "Self-storage facility ops — unit rentals, delinquent accounts/lien process, gate access, climate control.",
  "senior-living":
    "Assisted-living/memory-care facility ops — resident care, staffing ratios, family communication, safety.",
  ...
  veterinary:
    "Clinic ops for animals — vaccines, controlled substances, boarding, surgery scheduling, records, billing, licensing.",
  warehousing: "Warehouse facility ops — dock scheduling, pick/pack, slotting, labor, maintenance, safety.",
  "waste-management":
    "Waste hauling, recycling, and landfill/transfer-station ops — routes, contamination, tonnage, permits, billing.",
};
