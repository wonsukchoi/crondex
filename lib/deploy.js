...
// wants day names. Minute/hour/month/day-of-month pass through unchanged (AWS keeps
// cron's `-` for ranges) except `*/n` -> `0/n` (a bare `*` can't carry a step; AWS's
// own docs use `0/15`, not `*/15`, as the canonical form).
